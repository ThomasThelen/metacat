...
@RunWith(Suite.class)
@Suite.SuiteClasses({
    MNodeServiceIT.MNodeServiceITOriginMockCN.class,
    MNodeServiceIT.MNodeServiceITMockitoCN.class
})
public class MNodeServiceIT {
    ...
    /**
     * This class has those methods using a Mockito CN.
     */
    public static class MNodeServiceITMockitoCN {
        private static final String cnNodeId = "urn:node:mockitoCN";
        private CNode mockCN;
        private Subject cnSubject;
        private Session cnSession;
        private D1NodeServiceTest d1NodeTest = null;
        private MockHttpServletRequest request = null;
         ...
         */
        @Test
        public void mockTestSystemMetadataUpdated() throws Exception {
            Session session = d1NodeTest.getTestSession();
            NodeReference node = new NodeReference();
            node.setValue(cnNodeId);
            Node cnNode = new Node();
            cnNode.setIdentifier(node);
            cnNode.addSubject(cnSubject);
            cnNode.setType(NodeType.CN);
            // create the object
            Identifier pid = new Identifier();
